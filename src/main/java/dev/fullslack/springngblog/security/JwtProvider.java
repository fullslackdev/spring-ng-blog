...
import dev.fullslack.springngblog.exception.SpringBlogException;
...
public class JwtProvider {
    ...
    public void init() {
        try {
            ...
            keyStore.load(resourceAsStream, "keystore@1234".toCharArray());
    ...
    private PrivateKey getPrivateKey() {
        try {
            return (PrivateKey) keyStore.getKey("springblog", "keystore@1234".toCharArray());
